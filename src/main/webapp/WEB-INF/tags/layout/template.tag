...
<!-- Daterange picker -->
<link rel="stylesheet"
	href="<c:url value="/static/plugins/daterangepicker/daterangepicker.css"/>">
...
<body class="hold-transition skin-blue sidebar-mini fixed">
	...
	<!-- Bootstrap WYSIHTML5 -->
	<script
		src="<c:url value="/static/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"/>"></script>
	<!-- Slimscroll -->
